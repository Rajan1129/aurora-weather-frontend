      ...
      >
        <div className="glass-card p-8">
          ...
          <button
            ...
            disabled={loading}
            className="w-full py-3 border border-gray-300 dark:border-gray-700 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors"
          >
            Continue as Guest
          </button>
          ...
          <p className="text-center mt-6 text-sm text-gray-600 dark:text-gray-400">
            ...
            <Link to="/auth/register" className="ml-1 text-blue-600 dark:text-blue-400 hover:underline">
              Sign Up
            </Link>
          </p>
        </div>
